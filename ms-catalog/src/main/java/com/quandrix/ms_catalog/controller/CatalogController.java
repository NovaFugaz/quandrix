...
public class CatalogController {
    ...
    public ResponseEntity<CardResponse> getById(
            @Parameter(description = "Id único de Scryfall de la carta", required = true) @PathVariable String scryfallId) {
    ...
    public ResponseEntity<List<CardResponse>> search(
            @Parameter(description = "Nombre de la carta a buscar", required = true) @RequestParam String name) {
    ...
    public ResponseEntity<CardResponse> findByNameAndSet(
            @Parameter(description = "Nombre de la carta", required = true) @RequestParam String name,
            @Parameter(description = "Código del set (opcional)") @RequestParam(required = false) String setCode) {
